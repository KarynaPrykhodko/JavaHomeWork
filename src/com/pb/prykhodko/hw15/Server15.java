...
public class Server15 {
    ...
    static class Handler implements Runnable {
        ...
        public void run() {
            ...
            while (true) {
                ...
                out.println("Сервер: " + Calendar.getInstance().getTime() + " Сообщение клиента " + Thread.currentThread().getName() + ": " + clientMessage);
    ...
    public static void main(String[] args) throws Exception {
        ...
        while (true) {
            ...
            threadPool.submit(new Server15.Handler(clientSocket));
        }
    }
